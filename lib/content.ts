...
export const SCHEDULE = {
  ...
  days: [
    ...
    },
    {
      ...
      window: "10:00 AM – 7:00 PM",
      blurb:
        "A full day for the whole family — activities from 10:00 AM, the stage from 11:00 AM, plus worship, testimonies, food trucks, bouncy castles, games and joy. Free, all ages, all day.",
      accent: "gold",
      comingSoon: false,
      items: [
        { time: "10:00 AM", title: "Family Festival Opens", note: "Kids Zone · food trucks · vendors · activities", kind: "moment" },
        { time: "11:00 AM", title: "Stage Welcome & Prayer", note: "Opening prayer and welcome · MCs JJ & Rachel", kind: "moment" },
        { time: "11:15 AM", title: "Terry Posthumus", note: "Singer-songwriter · worship leader · opening artist", kind: "artist", featured: true, href: "https://www.jesusfestival.ca/artists/terry-posthumus" },
        { time: "12:30 PM", title: "I Am Second — Tanya", note: "Story from I Am Second / e3 Canada · Open Heaven sound check", kind: "speaker" },
        { time: "12:50 PM", title: "Open Heaven — Set 1", note: "Worship", kind: "artist" },
        { time: "1:20 PM", title: "Pastor Joanna Adams", note: "Speaker · 20-minute message", kind: "speaker" },
        { time: "1:40 PM", title: "Shofars & Pastors on Stage", note: "20-minute moment of unity for the churches of Hamilton", kind: "moment" },
        { time: "2:00 PM", title: "Open Heaven — Set 2", note: "Worship continues", kind: "artist" },
        { time: "2:20 PM", title: "Rachel Shares", note: "Story · ACTS Kingdom Sound Worship sound check", kind: "speaker" },
        { time: "2:40 PM", title: "ACTS Kingdom Sound Worship — Set 1", note: "Worship", kind: "artist" },
        { time: "3:10 PM", title: "Rachel Shares", note: "20-minute story", kind: "speaker" },
        { time: "3:30 PM", title: "ACTS Kingdom Sound Worship — Set 2", note: "Worship continues", kind: "artist" },
        { time: "3:50 PM", title: "Pastor Charles", note: "Bethel Gospel Tabernacle · Ant Lee Jr. sound check", kind: "speaker" },
        { time: "4:10 PM", title: "Ant Lee Jr. — Set 1", note: "Christian hip-hop", kind: "artist" },
        { time: "4:40 PM", title: "Ant Lee Jr. — Testimony", note: "20-minute testimony", kind: "speaker" },
        { time: "5:00 PM", title: "Ant Lee Jr. — Set 2", note: "Christian hip-hop continues", kind: "artist" },
        { time: "5:20 PM", title: "Daughters of Scripture", note: "Story · Friday Night Prayer sound check", kind: "speaker" },
        { time: "5:40 PM", title: "Friday Night Prayer — Set 1", note: "Worship", kind: "artist" },
        { time: "6:10 PM", title: "Sons of Scripture", note: "20-minute message", kind: "speaker" },
        { time: "6:30 PM", title: "Friday Night Prayer — Set 2", note: "Worship continues", kind: "artist" },
        { time: "7:00 PM", title: "Final Prayer — Daniel & Katie", note: "Prayer, encouragement and festival close", kind: "moment" },
      ],
    },
  ],
};
