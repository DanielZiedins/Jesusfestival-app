...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      { t: "p", text: "Jesus Festival is a **free, no-ticket-required outdoor festival** at Gage Park, 1000 Main Street East. Friday’s Pure Worship Night runs from 6:00–9:00 PM. Saturday’s all-ages festival runs from 10:00 AM–6:00 PM with live worship and music, testimonies, prayer, baptisms, a Kids Zone, bouncy castles, lawn games and food trucks." },
