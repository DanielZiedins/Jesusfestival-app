...
export const BLOG_POSTS: BlogPost[] = [
  {
    ...
    body: [
      ...
      { t: "p", text: "Saturday runs 10:00 AM to 6:00 PM. Nobody sensible does all eight hours with a toddler. Pick your window — the Kids Zone and the spray pad in the late morning, or the afternoon sets and the closing — and leave while everyone is still enjoying themselves." },
