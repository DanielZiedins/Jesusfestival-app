...
const SCREENS: Hit[] = [
  ...
  { id: "s-before-go", title: "Before You Go · Festival Go Bag", sub: "Final forecast, packing, route, meeting spot, lineup and offline save", emoji: "🎒", kind: "Screen", href: "/before-you-go", extra: "tomorrow tonight final checklist ready prepare weather rain what bring leave arrival detour offline" },
