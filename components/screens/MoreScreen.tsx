      ...
      {view === "hub" && (
          <motion.div key="hub" initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="px-4">
            ...
            <Reveal delay={0.09}>
              ...
              >
                <span className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-amber-300/15 text-3xl" aria-hidden>🚧</span>
                <span className="min-w-0 flex-1">
                  <span className="flex items-center gap-2"><span className="font-display text-lg font-extrabold text-white">Getting to Gage Park</span><span className="rounded-full bg-amber-300/15 px-2 py-0.5 text-[8px] font-extrabold uppercase tracking-wider text-amber-200">Current</span></span>
                  <span className="block text-xs leading-snug text-white/65">Road and HSR detours, parking facts and your personal leave-by time</span>
                </span>
                <ArrowRight width={18} height={18} className="shrink-0 text-amber-200 transition group-hover:translate-x-0.5" />
              </Link>
            </Reveal>
            ...
            <Reveal delay={0.08}>
              ...
              >
                <span className="grid h-14 w-14 shrink-0 place-items-center rounded-2xl bg-purple-400/15 text-3xl" aria-hidden>🫂</span>
                <span className="min-w-0 flex-1">
                  <span className="flex items-center gap-2">
                    <span className="font-display text-lg font-extrabold text-white">Bring a Group</span>
                  ...
                  <span className="block text-xs leading-snug text-white/65">Plan travel, a meeting point, roles and one shareable crew brief</span>
                </span>
                <ArrowRight width={18} height={18} className="shrink-0 text-purple-200 transition group-hover:translate-x-0.5" />
              </Link>
            </Reveal>
